...
收支單據（收款單/付款單/調撥單/手工傳票）→ 報表查詢（月報/BS/CF/預算；viewer 僅此組）→ 帳冊查詢（繳費總覽/應收明細表/應付明細表/預收明細表/代收付明細表/分類帳/日記帳）→ 社務管理（紅箱統計/Line請款/開立收據/活動管理/會議議程/社刊管理/行事曆）→ 基本設定（名冊/科目類別/期初/關帳）→ 系統管理（帳號）。
